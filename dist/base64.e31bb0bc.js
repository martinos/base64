...
var author$project$Main$viewOutput = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				function () {
				var _n0 = truqu$elm_base64$Base64$decode(
					A3(
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$stylesheet('https://cdnjs.cloudflare.com/ajax/libs/bulma/0.6.1/css/bulma.min.css'),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('Base64 Decode')
									])),
								A2(
								elm$html$Html$div,
								_List_fromArray(
													...
													[
														...
														_List_fromArray(
															[
																...
																A2(elm$html$Html$Attributes$attribute, 'rows', '30'),
																elm$html$Html$Attributes$placeholder('Enter your Base64'),
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"SetInput":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
...
//# sourceMappingURL=/base64.e31bb0bc.js.map